...
use Espo\Services\MysqlCharacter as EspoMysqlCharacter;
use Espo\Core\Utils\Database\Schema\Utils as Schema;
 ...
 */
class MysqlCharacter extends EspoMysqlCharacter
{
    ...
    public function jobConvertToMb4()
    {
        ...
        $fieldListExceededIndexMaxLength
            = Schema::getFieldListExceededIndexMaxLength($ormMeta, $maxIndexLength);
        ...
        foreach ($ormMeta as $entityName => $entityParams) {
            ...
            WHERE `Collation` <> 'utf8mb4_unicode_ci'";
            ...
            foreach ($entityParams['fields'] as $fieldName => $fieldParams) {
                ...
                if (!empty($query)) {
                    ...
                    try {
                        ...
                        $GLOBALS['log']
                            ->warning(
                                'Utf8mb4: FAILED executing the
                             query - [' . $query . '], details: ' . $e->getMessage() . '.'
                            );
                    }
                }
            }
