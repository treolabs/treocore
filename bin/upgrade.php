...
if (file_exists('data/repositories.json')) {
    $composer = array_merge_recursive($composer, json_decode(file_get_contents('data/repositories.json'), true));
}
...
//remove($rootPath . '/bin/upgrade.php');
