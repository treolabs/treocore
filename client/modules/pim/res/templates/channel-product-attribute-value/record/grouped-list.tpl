...
<div class="list">
    <div class="panel-heading">
        <div>
            ...
            <div class="pull-right btn-group">
                <button type="button" class="btn btn-default btn-sm action" data-action="addChannelAttribute" data-channel="{{channelId}}" title="{{translate 'Add'}}"><span class="glyphicon glyphicon-plus"></span></button>
                <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">
                    <span class="caret"></span>
                </button>
                <ul class="dropdown-menu">
                    <li><a href="javascript:" class="action" data-action="selectChannelAttributes" data-channel="{{channelId}}">{{translate 'Select'}}</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <table class="table">
        <tbody>
        <tr>
            <td class="cell">{{translate 'No Data'}}</td>
        </tr>
        </tbody>
    </table>
    {{/if}}
