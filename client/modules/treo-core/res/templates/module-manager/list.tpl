    ...
    <div class="col-sm-8 col-xs-12">
        <div class="module-list-container">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <span style="cursor: pointer;" class="action" title="{{translate 'clickToRefresh' category='messages'}}" data-action="refresh" data-collection="available">{{translate 'Store' scope='ModuleManager' category='labels'}}</span>
                    </h4>
                </div>
                <div class="panel-body">
