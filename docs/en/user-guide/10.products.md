...
<!-- [VT] ----- предлагаю заменить порядок полей как при создании товара на сайте, дополнить полями которых нет-->
...
<!-- [VT] ----- Product Family указано как обязательное, думаю это уже не актуально-->
...
<!-- [VT] ----- не совсем понимаю пункт, написано про редактирование и чего тип продукта не редактированный. Или расписать или убрать-->
...
<!-- [VT] ----- допиши где будет использоваться как филтр, как по мне не закончено-->
...
<!-- [VT] ----- нет кнопки + - https://i.imgur.com/n2UT218.png-->
...
<!-- [VT] ----- добавить скрин c отображением всех возможных связей-->
- Please refer to `Association Products` for more information.
<!-- [VT] ----- добавить линк на раздел-->
