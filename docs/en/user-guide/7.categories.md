...
<!-- [VT] ----- добавить скрин отображение списка и дерева -->
...
<!-- [VT] ----- тафтология is the category to which the category, нужно заменить описание например is the main category to which the child category is assigned to. -->
