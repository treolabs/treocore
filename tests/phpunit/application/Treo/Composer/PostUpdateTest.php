...
class PostUpdateTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Test is getComposerLockDiff method exists
     */
    public function testIsGetComposerLockDiffExists()
    {
        // test
        $this->assertTrue(method_exists($this->createPartialMock(PostUpdate::class, []), 'getComposerLockDiff'));
    }
}
